...
function ContactForm({ id }) {
    ...
    function validateForm() {
        ...
        // Messaggio
        if (!formValue.messaggio ||typeof formValue !== "string" || formValue.messaggio.length < 20) {
    ...
    return (
        <form onSubmit={handleFormSubmit}>
            ...
            <div className="mb-3">
                ...
                <textarea name="messaggio" value={formValue.messaggio} onChange={handleChangeInput} className="form-control" id="message" rows="3"></textarea>
                <div id="message" className="form-text">
                        Il messaggio deve essere di minimo 20 caratteri.
                    </div>
